...
F 1 "ATmega328P-MU" H 8700 5150 50  0000 C CNN
F 2 "Package_DFN_QFN:QFN-32-1EP_5x5mm_P0.5mm_EP3.1x3.1mm" H 8750 5100 50  0001 C CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/ATmega328_P%20AVR%20MCU%20with%20picoPower%20Technology%20Data%20Sheet%2040001984A.pdf" H 8750 5100 50  0001 C CNN
	1    8750 5100
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 3 "" H 8750 6700 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 8750 3300 1    50   UnSpc ~ 0
5V
$Comp
L Device:C C?
U 1 1 6001938B
P 8450 3500
F 0 "C?" H 8335 3454 50  0000 R CNN
F 1 "100n" H 8335 3545 50  0000 R CNN
...
U 1 1 60070624
P 10800 5550
F 0 "J?" H 10772 5432 50  0000 R CNN
F 1 "Conn_01x06_Male" H 10772 5523 50  0000 R CNN
...
Wire Wire Line
	9800 5400 9350 5400
Text GLabel 10150 5650 0    50   UnSpc ~ 0
5V
Wire Wire Line
	9950 5450 9950 4200
Wire Wire Line
	9950 4200 9350 4200
Text GLabel 9450 4900 2    50   UnSpc ~ 0
INT
Wire Wire Line
	9450 4900 9350 4900
Text GLabel 2650 6700 2    50   UnSpc ~ 0
INT
Wire Wire Line
	2650 6700 2500 6700
Text Notes 2950 7150 1    50   ~ 0
Interrupt trigger for CPU
Text GLabel 800  6450 0    50   BiDi ~ 0
SCL
Text GLabel 800  6600 0    50   BiDi ~ 0
SDA
Text GLabel 9400 5300 2    50   BiDi ~ 0
SCL
Wire Wire Line
	9400 5300 9350 5300
Wire Wire Line
...
Text GLabel 9400 5200 2    50   BiDi ~ 0
SDA
Wire Wire Line
	9400 5200 9350 5200
Text GLabel 9450 5700 2    50   UnSpc ~ 0
UART_TXD
Wire Wire Line
	9450 5700 9350 5700
Text GLabel 9450 5600 2    50   UnSpc ~ 0
UART_RXD
Wire Wire Line
	9450 5600 9350 5600
$Comp
...
U 1 1 6008913F
P 800 6900
F 0 "C?" H 915 6946 50  0000 L CNN
F 1 "220n" H 915 6855 50  0000 L CNN
...
Wire Wire Line
	1100 6950 1300 6950
Text GLabel 1700 5900 1    50   UnSpc ~ 0
3.3V
$Comp
L Device:C C?
U 1 1 6009E292
P 1850 6000
F 0 "C?" H 1965 6046 50  0000 L CNN
F 1 "100n" H 1965 5955 50  0000 L CNN
F 2 "" H 1888 5850 50  0001 C CNN
...
U 1 1 600D6749
P 1350 6000
F 0 "C?" V 1095 6000 50  0000 C CNN
F 1 "4.7u" V 1186 6000 50  0000 C CNN
...
U 1 1 600D7AA2
P 900 5850
F 0 "R?" V 693 5850 50  0000 C CNN
F 1 "2.2k" V 784 5850 50  0000 C CNN
...
F 1 "2.2k" V 934 6200 50  0000 C CNN
...
Wire Wire Line
	900  6450 1300 6450
Text GLabel 1050 6000 1    50   UnSpc ~ 0
3.3V
Wire Wire Line
	1050 6050 1050 6000
Text GLabel 1000 5700 2    50   UnSpc ~ 0
3.3V
Wire Wire Line
	1000 5700 900  5700
Text GLabel 2250 5900 1    50   UnSpc ~ 0
3.3V
Wire Wire Line
	2250 5900 2250 6000
Wire Wire Line
...
Wire Notes Line
	7800 3050 7800 7000
Wire Notes Line
	7800 7000 11550 7000
Wire Notes Line
	11550 7000 11550 3050
Wire Notes Line
	11550 3050 7800 3050
Text Notes 7800 7100 0    50   ~ 0
Host CPU.
$EndSCHEMATC
