...
U 1 1 5FDB2E3B
P 8050 1450
F 0 "F2" H 8050 1650 50  0000 C CNN
...
$Comp
L Digi_comp-rescue:PK20DX128VFM5-CPU U9
U 1 1 5FDA32A7
P 11250 1800
F 0 "U9" H 11250 1600 50  0000 C CNN
...
U 1 1 5FEC0074
P 9700 1450
F 0 "#PWR012" H 9700 1200 50  0001 C CNN
...
U 1 1 5FECB487
P 9350 2150
F 0 "C8" H 9465 2196 50  0000 L CNN
...
U 1 1 5FEED2D3
P 9350 2400
F 0 "#PWR011" H 9350 2150 50  0001 C CNN
...
U 1 1 5FEF8CB1
P 9800 2050
F 0 "#PWR013" H 9800 1800 50  0001 C CNN
...
Text Notes 13200 15550 0    50   ~ 0
MCU SOC unit (ARM Cortex M4 FPU) with bluetooth
Wire Notes Line
	13200 10650 13200 15450
Wire Notes Line
	18050 15450 13200 15450
Wire Notes Line
	18050 10650 18050 15450
Wire Notes Line
	13200 10650 18050 10650
Text Notes 15100 13300 0    50   ~ 0
QN9080 chip version
Wire Wire Line
...
U 1 1 5FE1A0CD
P 16250 11000
F 0 "#PWR014" H 16250 10750 50  0001 C CNN
F 1 "GND" H 16255 10827 50  0000 C CNN
...
$EndComp
Wire Wire Line
	16250 11400 16200 11400
$Comp
L power:GND #PWR015
U 1 1 5FE11A43
P 16250 11400
F 0 "#PWR015" H 16250 11150 50  0001 C CNN
F 1 "GND" H 16255 11227 50  0000 C CNN
F 2 "" H 16250 11400 50  0001 C CNN
F 3 "" H 16250 11400 50  0001 C CNN
	1    16250 11400
	1    0    0    -1  
$EndComp
Wire Wire Line
	16250 11800 16200 11800
$Comp
L power:GND #PWR016
U 1 1 5FE096DE
P 16250 11800
F 0 "#PWR016" H 16250 11550 50  0001 C CNN
F 1 "GND" H 16255 11627 50  0000 C CNN
...
$EndComp
Wire Wire Line
	15750 11800 15750 12000
Connection ~ 15750 11800
Wire Wire Line
	15900 11800 15750 11800
Wire Wire Line
	15750 10950 15750 11800
Text GLabel 15750 10950 1    50   UnSpc ~ 0
VCHIP
Wire Wire Line
	15600 11400 15600 12000
Connection ~ 15600 11400
Wire Wire Line
	15600 11400 15900 11400
Wire Wire Line
	15600 10950 15600 11400
Text GLabel 15600 10950 1    50   UnSpc ~ 0
VCHIP
Wire Wire Line
	15400 11400 15400 12000
Connection ~ 15400 11400
Wire Wire Line
	15550 11000 15900 11000
Wire Wire Line
	15550 11400 15550 11000
Wire Wire Line
	15400 11400 15550 11400
Wire Wire Line
...
U 1 1 5FDDB25A
P 16050 11000
F 0 "C9" V 15798 11000 50  0000 C CNN
F 1 "100n" V 15889 11000 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 16088 10850 50  0001 C CNN
...
U 1 1 5FDDAC74
P 16050 11800
F 0 "C17" V 15798 11800 50  0000 C CNN
F 1 "100n" V 15889 11800 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 16088 11650 50  0001 C CNN
...
U 1 1 5FDDA059
P 16050 11400
F 0 "C10" V 15798 11400 50  0000 C CNN
F 1 "100n" V 15889 11400 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 16088 11250 50  0001 C CNN
F 3 "~" H 16050 11400 50  0001 C CNN
	1    16050 11400
	0    1    1    0   
$EndComp
Text GLabel 15400 11300 1    50   UnSpc ~ 0
VCHIP
Wire Wire Line
	13650 12000 13600 12000
Text GLabel 13600 12000 0    50   UnSpc ~ 0
VCHIP
Wire Wire Line
	14050 12000 13950 12000
Wire Wire Line
	14400 12000 14350 12000
Wire Wire Line
	14400 12150 14400 12000
$Comp
L Device:L L2
U 1 1 5FDC45C3
P 13800 12000
F 0 "L2" V 13990 12000 50  0000 C CNN
F 1 "10n" V 13899 12000 50  0000 C CNN
F 2 "" H 13800 12000 50  0001 C CNN
...
U 1 1 5FDC3994
P 14200 12000
F 0 "L1" V 14390 12000 50  0000 C CNN
F 1 "10u" V 14299 12000 50  0000 C CNN
F 2 "" H 14200 12000 50  0001 C CNN
F 3 "~" H 14200 12000 50  0001 C CNN
	1    14200 12000
	0    -1   -1   0   
$EndComp
Text Notes 16500 15350 0    50   ~ 0
#ToDo: Antenna
Text GLabel 14000 13850 0    50   BiDi ~ 0
D-
Text GLabel 14000 13950 0    50   BiDi ~ 0
D+
Wire Wire Line
	14400 13850 14000 13850
Wire Wire Line
	14400 13950 14000 13950
Wire Wire Line
	16600 13750 17600 13750
Wire Wire Line
	16650 14900 16850 14900
Wire Wire Line
	16650 14500 16850 14500
Connection ~ 16650 14900
Wire Wire Line
	16650 14950 16650 14900
$Comp
L Device:C C11
U 1 1 5FE913DF
P 16650 15100
F 0 "C11" H 16765 15146 50  0000 L CNN
F 1 "8.2p" H 16765 15055 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 16688 14950 50  0001 C CNN
F 3 "~" H 16650 15100 50  0001 C CNN
	1    16650 15100
	1    0    0    -1  
$EndComp
Wire Wire Line
	16650 14900 16650 14850
Wire Wire Line
	17150 14900 17300 14900
Wire Wire Line
	17150 14500 17300 14500
Wire Wire Line
	16650 14500 16650 14550
Connection ~ 16650 14500
Wire Wire Line
	16650 13850 16650 14500
$Comp
L Device:L L4
U 1 1 5FE710AF
P 16650 14700
F 0 "L4" H 16607 14654 50  0000 R CNN
F 1 "3.3n" H 16607 14745 50  0000 R CNN
...
U 1 1 5FE7095C
P 17300 14900
F 0 "#PWR05" H 17300 14650 50  0001 C CNN
...
U 1 1 5FE70542
P 17000 14900
F 0 "C13" V 17252 14900 50  0000 C CNN
F 1 "1.8p" V 17161 14900 50  0000 C CNN
F 2 "" H 17038 14750 50  0001 C CNN
...
U 1 1 5FE7006B
P 17300 14500
F 0 "#PWR04" H 17300 14250 50  0001 C CNN
F 1 "GND" H 17305 14327 50  0000 C CNN
F 2 "" H 17300 14500 50  0001 C CNN
F 3 "" H 17300 14500 50  0001 C CNN
	1    17300 14500
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5FE6F20F
P 17000 14500
F 0 "C12" V 17252 14500 50  0000 C CNN
F 1 "1.8p" V 17161 14500 50  0000 C CNN
F 2 "" H 17038 14350 50  0001 C CNN
...
Wire Wire Line
	16600 14050 16850 14050
Wire Wire Line
	16600 13950 16850 13950
Wire Wire Line
	16600 12350 17050 12350
Wire Wire Line
	17050 12250 16600 12250
Text GLabel 17050 12250 2    50   BiDi ~ 0
SW_DIO
Text GLabel 17050 12350 2    50   Input ~ 0
SW_CLK
Wire Wire Line
	17600 13750 17750 13750
Connection ~ 17600 13750
Wire Wire Line
	17600 13850 17600 13750
Wire Wire Line
	17600 14250 17600 14150
$Comp
L power:GND #PWR06
U 1 1 5FE3C0AC
P 17600 14250
F 0 "#PWR06" H 17600 14000 50  0001 C CNN
F 1 "GND" H 17605 14077 50  0000 C CNN
F 2 "" H 17600 14250 50  0001 C CNN
...
U 1 1 5FE3B34F
P 17600 14000
F 0 "C14" H 17485 13954 50  0000 R CNN
F 1 "0.1u" H 17485 14045 50  0000 R CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 17638 13850 50  0001 C CNN
F 3 "~" H 17600 14000 50  0001 C CNN
	1    17600 14000
	-1   0    0    1   
$EndComp
Text GLabel 17750 13750 2    50   UnSpc ~ 0
RSTN
Wire Wire Line
	17050 13650 16600 13650
Text GLabel 17050 13650 2    50   Input ~ 0
CHIP_MODE
Wire Wire Line
	17050 12850 16600 12850
Wire Wire Line
	16600 12950 17050 12950
Text GLabel 17050 12850 2    50   Input ~ 0
ISP_RXD
Text GLabel 17050 12950 2    50   Output ~ 0
ISP_TXD
Wire Wire Line
	14650 11350 14800 11350
Wire Wire Line
...
U 1 1 5FDC8D7A
P 14650 11750
F 0 "#PWR0120" H 14650 11500 50  0001 C CNN
...
U 1 1 5FDBAAEF
P 14650 11350
F 0 "#PWR0119" H 14650 11100 50  0001 C CNN
F 1 "GND" H 14655 11177 50  0000 C CNN
F 2 "" H 14650 11350 50  0001 C CNN
...
U 1 1 5FDB52CA
P 14950 11750
F 0 "C7" V 14698 11750 50  0000 C CNN
F 1 "100n" V 14789 11750 50  0000 C CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 14988 11600 50  0001 C CNN
...
U 1 1 5FDB4896
P 14950 11350
F 0 "C4" V 14698 11350 50  0000 C CNN
F 1 "4.7u" V 14789 11350 50  0000 C CNN
F 2 "" H 14988 11200 50  0001 C CNN
F 3 "~" H 14950 11350 50  0001 C CNN
	1    14950 11350
	0    1    1    0   
$EndComp
Wire Wire Line
	15250 11750 15250 12000
Connection ~ 15250 11750
Wire Wire Line
	15100 11750 15250 11750
Connection ~ 15250 11350
Wire Wire Line
	15250 11350 15250 11750
Wire Wire Line
	15250 11350 15250 11250
Wire Wire Line
	15100 11350 15250 11350
Wire Wire Line
	16850 14150 17000 14150
Wire Wire Line
	16850 14050 16850 14150
Wire Wire Line
...
U 1 1 5FD7F837
P 17000 14000
F 0 "Y2" V 16954 14131 50  0000 L CNN
F 1 "16M/32M" V 17045 14131 50  0000 L CNN
F 2 "" H 17000 14000 50  0001 C CNN
F 3 "~" H 17000 14000 50  0001 C CNN
	1    17000 14000
	0    1    1    0   
$EndComp
Wire Wire Line
	14100 12250 14400 12250
Wire Wire Line
	14100 12150 14100 12250
Wire Wire Line
	13950 12150 14100 12150
Wire Wire Line
	14100 12450 13950 12450
Wire Wire Line
	14100 12350 14100 12450
Wire Wire Line
	14400 12350 14100 12350
$Comp
L Device:Crystal Y1
U 1 1 5FD757E4
P 13950 12300
F 0 "Y1" V 13996 12169 50  0000 R CNN
F 1 "32.768k" V 13905 12169 50  0000 R CNN
...
$EndComp
Wire Wire Line
	15600 14350 15600 14200
Wire Wire Line
	15450 14350 15450 14200
$Comp
L power:GND #PWR0118
U 1 1 5FD6CCB0
P 15600 14350
F 0 "#PWR0118" H 15600 14100 50  0001 C CNN
F 1 "GND" H 15605 14177 50  0000 C CNN
F 2 "" H 15600 14350 50  0001 C CNN
...
U 1 1 5FD6C32D
P 15450 14350
F 0 "#PWR0117" H 15450 14100 50  0001 C CNN
F 1 "GND" H 15455 14177 50  0000 C CNN
F 2 "" H 15450 14350 50  0001 C CNN
F 3 "" H 15450 14350 50  0001 C CNN
	1    15450 14350
	1    0    0    -1  
$EndComp
Text GLabel 15250 11250 1    50   UnSpc ~ 0
3.3V
$Comp
L Digi_comp-rescue:QN908x-RF_Bluetooth B1
U 1 1 5FD5B709
P 15500 13100
F 0 "B1" H 15500 13200 50  0000 C CNN
F 1 "QN908x" H 15500 13050 50  0000 C CNN
...
U 1 1 5FEB7CE5
P 7300 4950
F 0 "U8" H 7300 5815 50  0000 C CNN
F 1 "HC-06" H 7300 5724 50  0000 C CNN
F 2 "" H 7300 4950 50  0001 C CNN
F 3 "" H 7300 4950 50  0001 C CNN
	1    7300 4950
	1    0    0    -1  
$EndComp
Text GLabel 6550 5450 0    50   UnSpc ~ 0
3.3V
Wire Wire Line
	6550 5450 6750 5450
$Comp
...
U 1 1 5FEC4A1B
P 6750 5650
F 0 "#PWR02" H 6750 5400 50  0001 C CNN
...
U 1 1 5FEC6AAE
P 7650 6000
F 0 "#PWR03" H 7650 5750 50  0001 C CNN
...
Wire Wire Line
	7850 5650 7850 5550
Text GLabel 6550 4350 0    50   UnSpc ~ 0
UART_TXD
Text GLabel 6550 4450 0    50   UnSpc ~ 0
UART_RXD
Wire Wire Line
	6550 4350 6750 4350
Wire Wire Line
...
U 1 1 5FF121DF
P 8550 4950
F 0 "R17" V 8343 4950 50  0000 C CNN
...
U 1 1 5FF13A5C
P 8550 5350
F 0 "R18" V 8343 5350 50  0000 C CNN
F 1 "470" V 8434 5350 50  0000 C CNN
...
U 1 1 5FF15725
P 8250 5650
F 0 "R16" V 8043 5650 50  0000 C CNN
F 1 "470" V 8134 5650 50  0000 C CNN
...
U 1 1 5FF5B3BA
P 8250 4350
F 0 "R15" V 8043 4350 50  0000 C CNN
F 1 "470" V 8134 4350 50  0000 C CNN
...
Wire Wire Line
	8250 4500 8250 4600
Text GLabel 9300 4600 2    50   UnSpc ~ 0
3.3V
$Comp
L Device:LED D1
U 1 1 5FF69DBC
P 8950 5350
F 0 "D1" H 8943 5095 50  0000 C CNN
F 1 "LED" H 8943 5186 50  0000 C CNN
...
U 1 1 5FF6AC13
P 8850 4600
F 0 "JP1" H 8850 4864 50  0000 C CNN
F 1 "Jumper" H 8850 4773 50  0000 C CNN
...
Text GLabel 8250 4100 1    50   UnSpc ~ 0
KEY
Wire Wire Line
	8250 4200 8250 4100
Wire Wire Line
...
U 1 1 5FFAB8A7
P 9250 5500
F 0 "#PWR010" H 9250 5250 50  0001 C CNN
